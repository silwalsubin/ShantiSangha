...
namespace ShantiSangha.Goals.Migrations
{
    ...
    [Migration("20260414030000_AddJourneyReflections")]
    partial class AddJourneyReflections
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShantiSangha.Goals.Models.Goal", b =>
                {
                    ...
                    b.Property<string>("DeeperWhy").HasColumnType("text");
                    b.Property<string>("Frequency").HasColumnType("text");
                    b.Property<int?>("FrequencyTarget").HasColumnType("integer");
                    ...
                    b.HasKey("Id");
                    b.HasIndex("UserId");
                    b.HasIndex("UserId", "Title").IsUnique();
                    b.ToTable("Goals");
                });
            ...
            modelBuilder.Entity("ShantiSangha.Goals.Models.GoalCheckIn", b =>
                {
                    b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("uuid");
                    b.Property<bool>("Completed").HasColumnType("boolean");
                    b.Property<DateTime>("CreatedAt").HasColumnType("timestamp with time zone");
                    ...
                    b.HasKey("Id");
                    b.HasIndex("GoalId");
                    b.HasIndex("GoalId", "Date").IsUnique();
            ...
            modelBuilder.Entity("ShantiSangha.Goals.Models.JourneyReflection", b =>
                {
                    ...
                    b.Property<Guid>("UserId").HasColumnType("uuid");
                    b.HasKey("Id");
                    b.HasIndex("UserId", "FromDate", "ToDate").IsUnique();
