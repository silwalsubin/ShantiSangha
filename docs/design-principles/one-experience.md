...
The app is a single flowing journey, not a collection of separate tools.
...
- **Every screen connects to the next** — Home invites you to Reflect, Reflect feeds Journey
- **No orphan pages** — every page has a clear "where to go next"
