...
<template>
  <div class="mx-auto max-w-3xl space-y-6">
    ...
    <div class="rounded-3xl border border-[rgba(101,76,52,0.14)] bg-[rgba(255,250,243,0.82)] p-6 shadow-[0_8px_40px_rgba(82,54,29,0.08)] backdrop-blur-[14px]">
      ...
      <NuxtLink to="/app/chat" class="mt-3 block text-center text-xs text-[#8a5b3f] hover:underline">View all →</NuxtLink>
    </div>
    ...
    <div class="rounded-3xl border border-[rgba(101,76,52,0.14)] bg-[rgba(255,250,243,0.82)] p-6 shadow-[0_8px_40px_rgba(82,54,29,0.08)] backdrop-blur-[14px]">
      <div class="flex items-center justify-between">
        ...
        <NuxtLink to="/app/journal/new" class="rounded-full bg-[#2b221a] px-4 py-1.5 text-xs font-semibold text-[#fff8f1] transition hover:-translate-y-0.5">
          + New Entry
        </NuxtLink>
      </div>
      ...
      <NuxtLink to="/app/journal" class="mt-3 block text-center text-xs text-[#8a5b3f] hover:underline">View all →</NuxtLink>
    </div>
  </div>
</template>
