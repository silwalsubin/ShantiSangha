...
<template>
  <div class="mx-auto max-w-2xl space-y-5">
    <div class="flex items-center gap-3">
      <NuxtLink to="/app/journal" class="rounded-xl p-1.5 text-[#6c5c4d] transition hover:bg-[rgba(138,91,63,0.08)]">
    ...
    <div class="rounded-3xl border border-[rgba(101,76,52,0.14)] bg-[rgba(255,250,243,0.82)] p-6 shadow-[0_8px_40px_rgba(82,54,29,0.08)] backdrop-blur-[14px]">
      <div class="space-y-4">
        ...
        <div class="flex gap-3">
          ...
          <NuxtLink to="/app/journal" class="rounded-full border border-[rgba(101,76,52,0.16)] px-6 py-2.5 text-sm font-semibold text-[#6c5c4d] transition hover:bg-[rgba(138,91,63,0.06)]">
            Cancel
          </NuxtLink>
        </div>
      </div>
