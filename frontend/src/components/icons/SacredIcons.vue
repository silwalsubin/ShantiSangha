...
<template>
  ...
  <svg v-if="name === 'vajra'" :width="size || 22" :height="size || 22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <!-- Up -->
    <path d="M12 10V3.5" />
    <path d="M12 8C10 6.5 10.3 4 12 3.5" />
    <path d="M12 8C14 6.5 13.7 4 12 3.5" />
    <path d="M12 3.5L11.5 1.5" /><path d="M12 3.5L12.5 1.5" />
    <!-- Down -->
    <path d="M12 14V20.5" />
    <path d="M12 16C10 17.5 10.3 20 12 20.5" />
    <path d="M12 16C14 17.5 13.7 20 12 20.5" />
    <path d="M12 20.5L11.5 22.5" /><path d="M12 20.5L12.5 22.5" />
    <!-- Left -->
    <path d="M10 12H3.5" />
    <path d="M8 12C6.5 10 4 10.3 3.5 12" />
    <path d="M8 12C6.5 14 4 13.7 3.5 12" />
    <path d="M3.5 12L1.5 11.5" /><path d="M3.5 12L1.5 12.5" />
    <!-- Right -->
    <path d="M14 12H20.5" />
    <path d="M16 12C17.5 10 20 10.3 20.5 12" />
    <path d="M16 12C17.5 14 20 13.7 20.5 12" />
    <path d="M20.5 12L22.5 11.5" /><path d="M20.5 12L22.5 12.5" />
  </svg>
