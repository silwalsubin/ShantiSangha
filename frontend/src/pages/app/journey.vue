...
<template>
  <div class="mx-auto max-w-2xl space-y-5 p-4 sm:p-6">
    ...
    <div class="rounded-2xl border border-[rgba(139,90,43,0.12)] bg-[rgba(250,245,237,0.88)] p-4 shadow-[0_4px_24px_rgba(82,54,29,0.06)] backdrop-blur-[20px] sm:p-6">
      <p class="text-[9px] font-bold uppercase tracking-[0.2em] text-[#a38d6d]">Active Goals</p>
      ...
      <div v-else-if="goals.length === 0" class="mt-4 text-sm text-[#6b5740]">
        No active intentions yet. Set one from the Sacred Scrolls.
      </div>
    ...
    <div class="rounded-2xl border border-[rgba(139,90,43,0.12)] bg-[rgba(250,245,237,0.88)] p-4 shadow-[0_4px_24px_rgba(82,54,29,0.06)] backdrop-blur-[20px] sm:p-6">
      ...
      <div v-else-if="goals.length === 0" class="mt-4 text-sm text-[#6b5740]">
        Set intentions to see your weekly discipline here.
      </div>
