  ...
  routes: [
    ...
    { path: '/signup', redirect: '/login' },
    {
      ...
      children: [
        ...
        { path: 'journey/practices/:id', component: () => import('@/pages/app/practice-detail.vue') },
        { path: 'journey/practices/:id/calendar', component: () => import('@/pages/app/practice-calendar.vue') },
